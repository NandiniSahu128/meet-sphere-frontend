  ...
  return (
    <div className="landingPageContainer">
      ...
      <nav className="landingNav">
        <div className="navBrand" onClick={() => router.push('/')} style={{ cursor: 'pointer' }}>
          <h2>🎥 MeetSphere</h2>
        </div>
      ...
      <section className="landingCtaBanner">
        ...
        <div className="ctaBannerBtns">
          <button className="createBtn" onClick={() => router.push('/auth')}>
            Get Started Free
          </button>
      ...
      <footer className="landingFooter">
        ...
        <div className="footerLinks">
          ...
          <span onClick={() => router.push('/auth')}>Register</span>
          <span onClick={() => router.push('/history')}>History</span>
        </div>
      </footer>
    </div>
  );
